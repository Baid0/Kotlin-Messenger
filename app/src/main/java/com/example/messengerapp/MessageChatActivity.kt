...
class MessageChatActivity : AppCompatActivity()
{
                        ...
                        (object : Callback<MyResponse>
                        {
                            ...
                            )
                            {
                                if (response.code() == 200)
                                {
                                    ...
                                    {
                                        Toast.makeText(this@MessageChatActivity, "ერორი", Toast.LENGTH_LONG).show()
                                    }
                                }
                            }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode==438 && resultCode==RESULT_OK && data!=null && data!!.data!=null)
        {
            ...
            progressBar.setMessage("სურათი იტვირთება...")
            progressBar.show()
            ...
            uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>>{ task ->
                ...
                if (task.isSuccessful)
                {
                    ...
                    messageHashMap["message"] = "გამოგიგზავნა სურათი"
                            ...
                            if (task.isSuccessful)
                            {
                                ...
                                reference.addValueEventListener(object : ValueEventListener {
                                    override fun onDataChange(p0: DataSnapshot)
                                    {
                                        ...
                                        if (notify)
                                        {
                                            sendNotification(userIdVisit, user!!.getUserName(), "გამოგიგზავნა სურათი")
                                        }
                                        notify = false
                                    }
